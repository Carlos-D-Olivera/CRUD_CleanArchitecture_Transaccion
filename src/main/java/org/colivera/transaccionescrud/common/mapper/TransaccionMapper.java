package org.colivera.transaccionescrud.common.mapper;
...
public class TransaccionMapper {
    ...
    public static TransaccionModel transaccionEntityToModel(TransaccionEntity transaccionEntity){
        ...
        transaccionModel.setFechaTransaccion(transaccionEntity.getFechaTransaccion());
    ...
    public static TransaccionEntity transaccionModelToEntity(TransaccionModel transaccionModel){
        ...
        transaccionEntity.setFechaTransaccion(transaccionModel.getFechaTransaccion());
